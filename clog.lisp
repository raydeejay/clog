...
(defun process-additional-files (output-path)
  (declare (ignore output-path))
  (copy-file-to-directory (make-a-path (assoc-value *config* :source) "css/style.css")
                          (make-a-path (assoc-value *config* :output) "css"))
  (copy-file-to-directory (make-a-path (assoc-value *config* :source) "css/colorize.css")
                          (make-a-path (assoc-value *config* :output) "css"))
  (copy-file-to-directory (make-a-path (assoc-value *config* :source) "css/highlight.css")
                          (make-a-path (assoc-value *config* :output) "css"))
  (copy-file-to-directory (make-a-path (assoc-value *config* :source) "js/highlight.pack.js")
                          (make-a-path (assoc-value *config* :output) "js")))
